...
export default class Profile extends Component {
    ...
    handleUserData = () => {
        api.get(`doctor/profile/${this.state.id}`)
            .then(res => {
                this.setState({doctor:res.data.doctor},() => {
                    const profilePic = this.state.doctor.images.filter(img => img.isAvatar);
                    this.setState({avatar:profilePic,name:this.state.doctor.name});
                })
            })
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <idContext.Provider value = {{doctor:this.state.doctor}}>
                    <Menu 
