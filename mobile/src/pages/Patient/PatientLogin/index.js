...
import img from '../../../assets/images/pessoas.png';
...
export default class PLogin extends Component {
    ...
    handleNavigateMainScreen = (data) => {
        ...
        this.props.navigation.navigate('FindingDoctors',{info:'paciente',id:data.id});
    }
            ...
            <View style={styles.container}>
                ...
                <View style = {styles.content}>
                    <View style = {styles.body}>
                        ...
                        <RectButton onPress = { () => this.handleSignin()} style = {styles.button}>
                            <Text style = {styles.buttonText}>Login</Text>
                        </RectButton>
                        <TouchableWithoutFeedback style = {{marginTop: 15,marginBottom: 5}} onPress = { () => this.handleNavigatePatientSignUp()}>
